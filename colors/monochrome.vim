" Vim color file
" Name:       monochrome.vim
" Maintainer: Brighton Sikarskie <brighton.sikarskie@tuta.io>
...
call s:hi('Special')
call s:hi('MatchParen', s:lgray, s:black)
